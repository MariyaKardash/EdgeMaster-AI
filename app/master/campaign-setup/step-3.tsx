...
const CampaignSetupStep3Route = () => {
  ...
  const { ready, worklet, runWithoutCampaignRefresh, setError, setActiveCampaign, setCampaigns } =
    useCampaign();
  ...
  const handleFinalize = async () => {
    ...
    const { name, description, characters, availableItemIds } = campaignSetupStore;
